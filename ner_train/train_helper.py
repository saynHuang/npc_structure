...
def get_args_parser():
    ...
    root_path = 'D:/pyproject/npc_structure/ner_train'

    group1 = parser.add_argument_group('File Paths',
                                       'config the path, checkpoint and filename of a pretrained/fine-tuned BERT model')
    group1.add_argument('-data_dir', type=str, default='D:/pyproject/npc_structure/data',
    ...
    group1.add_argument('-output_dir', type=str, default=os.path.join(root_path, 'BERT_CRF_Model'),
    ...
    group2.add_argument('-max_seq_length', type=int, default=50,
    ...
    group2.add_argument('-learning_rate', type=float, default=0.001,
    ...
    group2.add_argument('-save_checkpoints_steps', type=int, default=10000,
