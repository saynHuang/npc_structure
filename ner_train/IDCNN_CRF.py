...
def train_model(data_dir, model_save_dir):
    ...
    with tf.Session() as sess:
        ...
        save_path = saver.save(sess, os.path.join(model_save_dir, 'idcnn_crf'))
    ...
    plot_loss(train_loss, dev_loss, model_save_dir, 'idcnn_crf')
...
def load_model(data_dir, model_save_dir):
    ...
    model_name = 'idcnn_crf.meta'
    pred_name = 'idcnn_crf_predict_score.txt'
    # 加载转移矩阵
...
if __name__ == '__main__':
    ...
    epochs = 50
    lr = 0.001
    model_save_dir = '../ner_train/IDCNN_CRF_Model'
